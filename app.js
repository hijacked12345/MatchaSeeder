...
app.post('/seeders', (req, res) => {
    for (var i = 0; i < 5; i++) {
        ...
        var genderRandom = gender[Math.floor(Math.random() * 2)];
        var orientation = ["heterosexual", "bisexual", "homosexual"];
        var orientationRandom = orientation[Math.floor(Math.random() * 3)];
        var fakee = new User({
            ...
            completedInfo: true,
            completedPics: true,
            dob: faker.date.past(minimum_age = 18, maximum_age = 80),
            orientation: orientation[orientationRandom],
            gender: gender[genderRandom],
            bio: faker.lorem.text(20),
